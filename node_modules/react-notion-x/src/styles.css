:root {
  ...
  --fg-color-0: rgba(25, 25, 25, 0.09);
  --fg-color-1: rgba(25, 25, 25, 0.16);
  --fg-color-2: rgba(25, 25, 25, 0.4);
  --fg-color-3: rgba(25, 25, 25, 0.6);
  --fg-color-4: #000;
  --fg-color-5: rgba(25, 25, 25, 0.024);
  --fg-color-6: rgba(25, 25, 25, 0.8);
...
.dark-mode {
  --fg-color: rgba(212, 212, 212, 1);
  --fg-color-0: var(--fg-color);
  --fg-color-1: var(--fg-color);
  --fg-color-2: rgba(212, 212, 212, 0.25);
...
.notion-table-header-inner {
  ...
  border-bottom: 1px solid var(--fg-color-1);
  /* box-shadow: white -3px 0 0, rgba(25, 25, 25, 0.16) 0 1px 0; */
}
...
.notion-search .searchBar {
  ...
  align-items: center;
  height: 52px;
  box-shadow: rgba(25, 25, 25, 0.09) 0px 1px 0px;
  font-size: 18px;
  line-height: 27px;
  padding: 16px;
}
